...
<head>
  ...
  <title>DevSecOps | Alta de reportes de seguridad </title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="card-header">
          <h3 class="card-title"><b>Alta de reportes de seguridad</b></h3>
          <div class="card-tools">

          </div>
        </div>

        <form action="nuevo_reporte_seguridad.php" method="POST">
